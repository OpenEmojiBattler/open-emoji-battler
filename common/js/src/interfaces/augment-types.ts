...
import type { emo_Attributes, emo_Base, emo_Bases, emo_Typ, emo_ability_Ability, emo_ability_Destination, emo_ability_Side, emo_ability_Target, emo_ability_TargetOrRandom, emo_ability_TargetOrRandom_Random, emo_ability_Target_Others, emo_ability_TypOptAndIsTripleOpt, emo_ability_battle_AsAllyAction, emo_ability_battle_Battle, emo_ability_battle_General, emo_ability_battle_GeneralAsAllyAction, emo_ability_battle_GeneralAsAllyTrigger, emo_ability_battle_GeneralAsAllyTrigger_AllyRetire, emo_ability_battle_GeneralAsAllyTrigger_AllySet, emo_ability_battle_GeneralAsOneselfTrigger, emo_ability_battle_GeneralAsOneselfTrigger_AllyBattleAbilityRemoved, emo_ability_battle_GeneralAsOneselfTrigger_AllyRetire, emo_ability_battle_GeneralAsOneselfTrigger_RivalRetire, emo_ability_battle_General_AsAlly, emo_ability_battle_General_AsOneself, emo_ability_battle_NormalAction, emo_ability_battle_NormalAction_AddBattleAbility, emo_ability_battle_NormalAction_DamageAll, emo_ability_battle_NormalAction_DecreaseStats, emo_ability_battle_NormalAction_IncreaseStats, emo_ability_battle_NormalAction_IncreaseStatsByEmoCount, emo_ability_battle_NormalAction_SetEmo, emo_ability_battle_NormalAction_SetEmosByAttackDiv, emo_ability_battle_Special, emo_ability_shop_AsAllyAction, emo_ability_shop_NormalAction, emo_ability_shop_NormalAction_AddAbility, emo_ability_shop_NormalAction_GetCoin, emo_ability_shop_NormalAction_GetCoinByEmoCountDiv, emo_ability_shop_NormalAction_IncreaseStats, emo_ability_shop_NormalAction_IncreaseStatsByEmoCount, emo_ability_shop_NormalAction_IncreaseStatsByGrade, emo_ability_shop_NormalAction_IncreaseStatsOfAdjacentMenagerie, emo_ability_shop_NormalAction_SetEmo, emo_ability_shop_Peri, emo_ability_shop_PeriAsAllyAction, emo_ability_shop_PeriAsAllyTrigger, emo_ability_shop_PeriAsAllyTrigger_AllySet, emo_ability_shop_PeriAsOneselfTrigger, emo_ability_shop_PeriAsOneselfTrigger_AllySet, emo_ability_shop_Peri_AsAlly, emo_ability_shop_Peri_AsOneself, emo_ability_shop_Pre, emo_ability_shop_RandomAction, emo_ability_shop_RandomAction_IncreaseStatsOfMenagerie, emo_ability_shop_Shop, emo_ability_shop_Special, mtc_Board, mtc_BoardEmo, mtc_Emo, mtc_Ghost, mtc_GhostBoard, mtc_GhostBoardEmo, mtc_GhostState, mtc_GhostState_Active, mtc_GhostState_Retired, mtc_GradeAndBoard, mtc_GradeAndGhostBoard, mtc_battle_Log, mtc_battle_Log_Add, mtc_battle_Log_AddBattleAbility, mtc_battle_Log_Attack, mtc_battle_Log_Damage, mtc_battle_Log_DecreaseStats, mtc_battle_Log_IncreaseStats, mtc_battle_Log_Remove, mtc_battle_Log_RemoveBattleAbility, mtc_battle_Logs, mtc_shop_BoardLog, mtc_shop_BoardLog_Add, mtc_shop_BoardLog_AddAbility, mtc_shop_BoardLog_IncreaseStats, mtc_shop_BoardLog_Move, mtc_shop_BoardLog_Remove, mtc_shop_BoardLog_Triple, mtc_shop_BoardLogs, mtc_shop_Catalog, mtc_shop_CatalogLine, mtc_shop_PlayerOperation, mtc_shop_PlayerOperation_Buy, mtc_shop_PlayerOperation_Move, mtc_shop_PlayerOperation_Sell } from './all';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Option<emo_ability_Ability>': Option<emo_ability_Ability>;
    'Option<emo_ability_battle_AsAllyAction>': Option<emo_ability_battle_AsAllyAction>;
    'Option<emo_ability_battle_Battle>': Option<emo_ability_battle_Battle>;
    'Option<emo_ability_battle_General_AsAlly>': Option<emo_ability_battle_General_AsAlly>;
    'Option<emo_ability_battle_General_AsOneself>': Option<emo_ability_battle_General_AsOneself>;
    'Option<emo_ability_battle_General>': Option<emo_ability_battle_General>;
    'Option<emo_ability_battle_GeneralAsAllyAction>': Option<emo_ability_battle_GeneralAsAllyAction>;
    'Option<emo_ability_battle_GeneralAsAllyTrigger_AllyRetire>': Option<emo_ability_battle_GeneralAsAllyTrigger_AllyRetire>;
    'Option<emo_ability_battle_GeneralAsAllyTrigger_AllySet>': Option<emo_ability_battle_GeneralAsAllyTrigger_AllySet>;
    'Option<emo_ability_battle_GeneralAsAllyTrigger>': Option<emo_ability_battle_GeneralAsAllyTrigger>;
    'Option<emo_ability_battle_GeneralAsOneselfTrigger_AllyBattleAbilityRemoved>': Option<emo_ability_battle_GeneralAsOneselfTrigger_AllyBattleAbilityRemoved>;
    'Option<emo_ability_battle_GeneralAsOneselfTrigger_AllyRetire>': Option<emo_ability_battle_GeneralAsOneselfTrigger_AllyRetire>;
    'Option<emo_ability_battle_GeneralAsOneselfTrigger_RivalRetire>': Option<emo_ability_battle_GeneralAsOneselfTrigger_RivalRetire>;
    'Option<emo_ability_battle_GeneralAsOneselfTrigger>': Option<emo_ability_battle_GeneralAsOneselfTrigger>;
    'Option<emo_ability_battle_NormalAction_AddBattleAbility>': Option<emo_ability_battle_NormalAction_AddBattleAbility>;
    'Option<emo_ability_battle_NormalAction_DamageAll>': Option<emo_ability_battle_NormalAction_DamageAll>;
    'Option<emo_ability_battle_NormalAction_DecreaseStats>': Option<emo_ability_battle_NormalAction_DecreaseStats>;
    'Option<emo_ability_battle_NormalAction_IncreaseStats>': Option<emo_ability_battle_NormalAction_IncreaseStats>;
    'Option<emo_ability_battle_NormalAction_IncreaseStatsByEmoCount>': Option<emo_ability_battle_NormalAction_IncreaseStatsByEmoCount>;
    'Option<emo_ability_battle_NormalAction_SetEmo>': Option<emo_ability_battle_NormalAction_SetEmo>;
    'Option<emo_ability_battle_NormalAction_SetEmosByAttackDiv>': Option<emo_ability_battle_NormalAction_SetEmosByAttackDiv>;
    'Option<emo_ability_battle_NormalAction>': Option<emo_ability_battle_NormalAction>;
    'Option<emo_ability_battle_Special>': Option<emo_ability_battle_Special>;
    'Option<emo_ability_Destination>': Option<emo_ability_Destination>;
    'Option<emo_ability_shop_AsAllyAction>': Option<emo_ability_shop_AsAllyAction>;
    'Option<emo_ability_shop_NormalAction_AddAbility>': Option<emo_ability_shop_NormalAction_AddAbility>;
    'Option<emo_ability_shop_NormalAction_GetCoin>': Option<emo_ability_shop_NormalAction_GetCoin>;
    'Option<emo_ability_shop_NormalAction_GetCoinByEmoCountDiv>': Option<emo_ability_shop_NormalAction_GetCoinByEmoCountDiv>;
    'Option<emo_ability_shop_NormalAction_IncreaseStats>': Option<emo_ability_shop_NormalAction_IncreaseStats>;
    'Option<emo_ability_shop_NormalAction_IncreaseStatsByEmoCount>': Option<emo_ability_shop_NormalAction_IncreaseStatsByEmoCount>;
    'Option<emo_ability_shop_NormalAction_IncreaseStatsByGrade>': Option<emo_ability_shop_NormalAction_IncreaseStatsByGrade>;
    'Option<emo_ability_shop_NormalAction_IncreaseStatsOfAdjacentMenagerie>': Option<emo_ability_shop_NormalAction_IncreaseStatsOfAdjacentMenagerie>;
    'Option<emo_ability_shop_NormalAction_SetEmo>': Option<emo_ability_shop_NormalAction_SetEmo>;
    'Option<emo_ability_shop_NormalAction>': Option<emo_ability_shop_NormalAction>;
    'Option<emo_ability_shop_Peri_AsAlly>': Option<emo_ability_shop_Peri_AsAlly>;
    'Option<emo_ability_shop_Peri_AsOneself>': Option<emo_ability_shop_Peri_AsOneself>;
    'Option<emo_ability_shop_Peri>': Option<emo_ability_shop_Peri>;
    'Option<emo_ability_shop_PeriAsAllyAction>': Option<emo_ability_shop_PeriAsAllyAction>;
    'Option<emo_ability_shop_PeriAsAllyTrigger_AllySet>': Option<emo_ability_shop_PeriAsAllyTrigger_AllySet>;
    'Option<emo_ability_shop_PeriAsAllyTrigger>': Option<emo_ability_shop_PeriAsAllyTrigger>;
    'Option<emo_ability_shop_PeriAsOneselfTrigger_AllySet>': Option<emo_ability_shop_PeriAsOneselfTrigger_AllySet>;
    'Option<emo_ability_shop_PeriAsOneselfTrigger>': Option<emo_ability_shop_PeriAsOneselfTrigger>;
    'Option<emo_ability_shop_Pre>': Option<emo_ability_shop_Pre>;
    'Option<emo_ability_shop_RandomAction_IncreaseStatsOfMenagerie>': Option<emo_ability_shop_RandomAction_IncreaseStatsOfMenagerie>;
    'Option<emo_ability_shop_RandomAction>': Option<emo_ability_shop_RandomAction>;
    'Option<emo_ability_shop_Shop>': Option<emo_ability_shop_Shop>;
    'Option<emo_ability_shop_Special>': Option<emo_ability_shop_Special>;
    'Option<emo_ability_Side>': Option<emo_ability_Side>;
    'Option<emo_ability_Target_Others>': Option<emo_ability_Target_Others>;
    'Option<emo_ability_Target>': Option<emo_ability_Target>;
    'Option<emo_ability_TargetOrRandom_Random>': Option<emo_ability_TargetOrRandom_Random>;
    'Option<emo_ability_TargetOrRandom>': Option<emo_ability_TargetOrRandom>;
    'Option<emo_ability_TypOptAndIsTripleOpt>': Option<emo_ability_TypOptAndIsTripleOpt>;
    'Option<emo_Attributes>': Option<emo_Attributes>;
    'Option<emo_Base>': Option<emo_Base>;
    'Option<emo_Bases>': Option<emo_Bases>;
    'Option<emo_Typ>': Option<emo_Typ>;
    ...
    'Option<mtc_battle_Log_Add>': Option<mtc_battle_Log_Add>;
    'Option<mtc_battle_Log_AddBattleAbility>': Option<mtc_battle_Log_AddBattleAbility>;
    'Option<mtc_battle_Log_Attack>': Option<mtc_battle_Log_Attack>;
    'Option<mtc_battle_Log_Damage>': Option<mtc_battle_Log_Damage>;
    'Option<mtc_battle_Log_DecreaseStats>': Option<mtc_battle_Log_DecreaseStats>;
    'Option<mtc_battle_Log_IncreaseStats>': Option<mtc_battle_Log_IncreaseStats>;
    'Option<mtc_battle_Log_Remove>': Option<mtc_battle_Log_Remove>;
    'Option<mtc_battle_Log_RemoveBattleAbility>': Option<mtc_battle_Log_RemoveBattleAbility>;
    'Option<mtc_battle_Log>': Option<mtc_battle_Log>;
    'Option<mtc_battle_Logs>': Option<mtc_battle_Logs>;
    'Option<mtc_Board>': Option<mtc_Board>;
    'Option<mtc_BoardEmo>': Option<mtc_BoardEmo>;
    'Option<mtc_Emo>': Option<mtc_Emo>;
    'Option<mtc_Ghost>': Option<mtc_Ghost>;
    'Option<mtc_GhostBoard>': Option<mtc_GhostBoard>;
    'Option<mtc_GhostBoardEmo>': Option<mtc_GhostBoardEmo>;
    'Option<mtc_GhostState_Active>': Option<mtc_GhostState_Active>;
    'Option<mtc_GhostState_Retired>': Option<mtc_GhostState_Retired>;
    'Option<mtc_GhostState>': Option<mtc_GhostState>;
    'Option<mtc_GradeAndBoard>': Option<mtc_GradeAndBoard>;
    'Option<mtc_GradeAndGhostBoard>': Option<mtc_GradeAndGhostBoard>;
    'Option<mtc_shop_BoardLog_Add>': Option<mtc_shop_BoardLog_Add>;
    'Option<mtc_shop_BoardLog_AddAbility>': Option<mtc_shop_BoardLog_AddAbility>;
    'Option<mtc_shop_BoardLog_IncreaseStats>': Option<mtc_shop_BoardLog_IncreaseStats>;
    'Option<mtc_shop_BoardLog_Move>': Option<mtc_shop_BoardLog_Move>;
    'Option<mtc_shop_BoardLog_Remove>': Option<mtc_shop_BoardLog_Remove>;
    'Option<mtc_shop_BoardLog_Triple>': Option<mtc_shop_BoardLog_Triple>;
    'Option<mtc_shop_BoardLog>': Option<mtc_shop_BoardLog>;
    'Option<mtc_shop_BoardLogs>': Option<mtc_shop_BoardLogs>;
    'Option<mtc_shop_Catalog>': Option<mtc_shop_Catalog>;
    'Option<mtc_shop_CatalogLine>': Option<mtc_shop_CatalogLine>;
    'Option<mtc_shop_PlayerOperation_Buy>': Option<mtc_shop_PlayerOperation_Buy>;
    'Option<mtc_shop_PlayerOperation_Move>': Option<mtc_shop_PlayerOperation_Move>;
    'Option<mtc_shop_PlayerOperation_Sell>': Option<mtc_shop_PlayerOperation_Sell>;
    'Option<mtc_shop_PlayerOperation>': Option<mtc_shop_PlayerOperation>;
    ...
    'Vec<emo_ability_Ability>': Vec<emo_ability_Ability>;
    'Vec<emo_ability_battle_AsAllyAction>': Vec<emo_ability_battle_AsAllyAction>;
    'Vec<emo_ability_battle_Battle>': Vec<emo_ability_battle_Battle>;
    'Vec<emo_ability_battle_General_AsAlly>': Vec<emo_ability_battle_General_AsAlly>;
    'Vec<emo_ability_battle_General_AsOneself>': Vec<emo_ability_battle_General_AsOneself>;
    'Vec<emo_ability_battle_General>': Vec<emo_ability_battle_General>;
    'Vec<emo_ability_battle_GeneralAsAllyAction>': Vec<emo_ability_battle_GeneralAsAllyAction>;
    'Vec<emo_ability_battle_GeneralAsAllyTrigger_AllyRetire>': Vec<emo_ability_battle_GeneralAsAllyTrigger_AllyRetire>;
    'Vec<emo_ability_battle_GeneralAsAllyTrigger_AllySet>': Vec<emo_ability_battle_GeneralAsAllyTrigger_AllySet>;
    'Vec<emo_ability_battle_GeneralAsAllyTrigger>': Vec<emo_ability_battle_GeneralAsAllyTrigger>;
    'Vec<emo_ability_battle_GeneralAsOneselfTrigger_AllyBattleAbilityRemoved>': Vec<emo_ability_battle_GeneralAsOneselfTrigger_AllyBattleAbilityRemoved>;
    'Vec<emo_ability_battle_GeneralAsOneselfTrigger_AllyRetire>': Vec<emo_ability_battle_GeneralAsOneselfTrigger_AllyRetire>;
    'Vec<emo_ability_battle_GeneralAsOneselfTrigger_RivalRetire>': Vec<emo_ability_battle_GeneralAsOneselfTrigger_RivalRetire>;
    'Vec<emo_ability_battle_GeneralAsOneselfTrigger>': Vec<emo_ability_battle_GeneralAsOneselfTrigger>;
    'Vec<emo_ability_battle_NormalAction_AddBattleAbility>': Vec<emo_ability_battle_NormalAction_AddBattleAbility>;
    'Vec<emo_ability_battle_NormalAction_DamageAll>': Vec<emo_ability_battle_NormalAction_DamageAll>;
    'Vec<emo_ability_battle_NormalAction_DecreaseStats>': Vec<emo_ability_battle_NormalAction_DecreaseStats>;
    'Vec<emo_ability_battle_NormalAction_IncreaseStats>': Vec<emo_ability_battle_NormalAction_IncreaseStats>;
    'Vec<emo_ability_battle_NormalAction_IncreaseStatsByEmoCount>': Vec<emo_ability_battle_NormalAction_IncreaseStatsByEmoCount>;
    'Vec<emo_ability_battle_NormalAction_SetEmo>': Vec<emo_ability_battle_NormalAction_SetEmo>;
    'Vec<emo_ability_battle_NormalAction_SetEmosByAttackDiv>': Vec<emo_ability_battle_NormalAction_SetEmosByAttackDiv>;
    'Vec<emo_ability_battle_NormalAction>': Vec<emo_ability_battle_NormalAction>;
    'Vec<emo_ability_battle_Special>': Vec<emo_ability_battle_Special>;
    'Vec<emo_ability_Destination>': Vec<emo_ability_Destination>;
    'Vec<emo_ability_shop_AsAllyAction>': Vec<emo_ability_shop_AsAllyAction>;
    'Vec<emo_ability_shop_NormalAction_AddAbility>': Vec<emo_ability_shop_NormalAction_AddAbility>;
    'Vec<emo_ability_shop_NormalAction_GetCoin>': Vec<emo_ability_shop_NormalAction_GetCoin>;
    'Vec<emo_ability_shop_NormalAction_GetCoinByEmoCountDiv>': Vec<emo_ability_shop_NormalAction_GetCoinByEmoCountDiv>;
    'Vec<emo_ability_shop_NormalAction_IncreaseStats>': Vec<emo_ability_shop_NormalAction_IncreaseStats>;
    'Vec<emo_ability_shop_NormalAction_IncreaseStatsByEmoCount>': Vec<emo_ability_shop_NormalAction_IncreaseStatsByEmoCount>;
    'Vec<emo_ability_shop_NormalAction_IncreaseStatsByGrade>': Vec<emo_ability_shop_NormalAction_IncreaseStatsByGrade>;
    'Vec<emo_ability_shop_NormalAction_IncreaseStatsOfAdjacentMenagerie>': Vec<emo_ability_shop_NormalAction_IncreaseStatsOfAdjacentMenagerie>;
    'Vec<emo_ability_shop_NormalAction_SetEmo>': Vec<emo_ability_shop_NormalAction_SetEmo>;
    'Vec<emo_ability_shop_NormalAction>': Vec<emo_ability_shop_NormalAction>;
    'Vec<emo_ability_shop_Peri_AsAlly>': Vec<emo_ability_shop_Peri_AsAlly>;
    'Vec<emo_ability_shop_Peri_AsOneself>': Vec<emo_ability_shop_Peri_AsOneself>;
    'Vec<emo_ability_shop_Peri>': Vec<emo_ability_shop_Peri>;
    'Vec<emo_ability_shop_PeriAsAllyAction>': Vec<emo_ability_shop_PeriAsAllyAction>;
    'Vec<emo_ability_shop_PeriAsAllyTrigger_AllySet>': Vec<emo_ability_shop_PeriAsAllyTrigger_AllySet>;
    'Vec<emo_ability_shop_PeriAsAllyTrigger>': Vec<emo_ability_shop_PeriAsAllyTrigger>;
    'Vec<emo_ability_shop_PeriAsOneselfTrigger_AllySet>': Vec<emo_ability_shop_PeriAsOneselfTrigger_AllySet>;
    'Vec<emo_ability_shop_PeriAsOneselfTrigger>': Vec<emo_ability_shop_PeriAsOneselfTrigger>;
    'Vec<emo_ability_shop_Pre>': Vec<emo_ability_shop_Pre>;
    'Vec<emo_ability_shop_RandomAction_IncreaseStatsOfMenagerie>': Vec<emo_ability_shop_RandomAction_IncreaseStatsOfMenagerie>;
    'Vec<emo_ability_shop_RandomAction>': Vec<emo_ability_shop_RandomAction>;
    'Vec<emo_ability_shop_Shop>': Vec<emo_ability_shop_Shop>;
    'Vec<emo_ability_shop_Special>': Vec<emo_ability_shop_Special>;
    'Vec<emo_ability_Side>': Vec<emo_ability_Side>;
    'Vec<emo_ability_Target_Others>': Vec<emo_ability_Target_Others>;
    'Vec<emo_ability_Target>': Vec<emo_ability_Target>;
    'Vec<emo_ability_TargetOrRandom_Random>': Vec<emo_ability_TargetOrRandom_Random>;
    'Vec<emo_ability_TargetOrRandom>': Vec<emo_ability_TargetOrRandom>;
    'Vec<emo_ability_TypOptAndIsTripleOpt>': Vec<emo_ability_TypOptAndIsTripleOpt>;
    'Vec<emo_Attributes>': Vec<emo_Attributes>;
    'Vec<emo_Base>': Vec<emo_Base>;
    'Vec<emo_Bases>': Vec<emo_Bases>;
    'Vec<emo_Typ>': Vec<emo_Typ>;
    ...
    'Vec<mtc_battle_Log_Add>': Vec<mtc_battle_Log_Add>;
    'Vec<mtc_battle_Log_AddBattleAbility>': Vec<mtc_battle_Log_AddBattleAbility>;
    'Vec<mtc_battle_Log_Attack>': Vec<mtc_battle_Log_Attack>;
    'Vec<mtc_battle_Log_Damage>': Vec<mtc_battle_Log_Damage>;
    'Vec<mtc_battle_Log_DecreaseStats>': Vec<mtc_battle_Log_DecreaseStats>;
    'Vec<mtc_battle_Log_IncreaseStats>': Vec<mtc_battle_Log_IncreaseStats>;
    'Vec<mtc_battle_Log_Remove>': Vec<mtc_battle_Log_Remove>;
    'Vec<mtc_battle_Log_RemoveBattleAbility>': Vec<mtc_battle_Log_RemoveBattleAbility>;
    'Vec<mtc_battle_Log>': Vec<mtc_battle_Log>;
    'Vec<mtc_battle_Logs>': Vec<mtc_battle_Logs>;
    'Vec<mtc_Board>': Vec<mtc_Board>;
    'Vec<mtc_BoardEmo>': Vec<mtc_BoardEmo>;
    'Vec<mtc_Emo>': Vec<mtc_Emo>;
    'Vec<mtc_Ghost>': Vec<mtc_Ghost>;
    'Vec<mtc_GhostBoard>': Vec<mtc_GhostBoard>;
    'Vec<mtc_GhostBoardEmo>': Vec<mtc_GhostBoardEmo>;
    'Vec<mtc_GhostState_Active>': Vec<mtc_GhostState_Active>;
    'Vec<mtc_GhostState_Retired>': Vec<mtc_GhostState_Retired>;
    'Vec<mtc_GhostState>': Vec<mtc_GhostState>;
    'Vec<mtc_GradeAndBoard>': Vec<mtc_GradeAndBoard>;
    'Vec<mtc_GradeAndGhostBoard>': Vec<mtc_GradeAndGhostBoard>;
    'Vec<mtc_shop_BoardLog_Add>': Vec<mtc_shop_BoardLog_Add>;
    'Vec<mtc_shop_BoardLog_AddAbility>': Vec<mtc_shop_BoardLog_AddAbility>;
    'Vec<mtc_shop_BoardLog_IncreaseStats>': Vec<mtc_shop_BoardLog_IncreaseStats>;
    'Vec<mtc_shop_BoardLog_Move>': Vec<mtc_shop_BoardLog_Move>;
    'Vec<mtc_shop_BoardLog_Remove>': Vec<mtc_shop_BoardLog_Remove>;
    'Vec<mtc_shop_BoardLog_Triple>': Vec<mtc_shop_BoardLog_Triple>;
    'Vec<mtc_shop_BoardLog>': Vec<mtc_shop_BoardLog>;
    'Vec<mtc_shop_BoardLogs>': Vec<mtc_shop_BoardLogs>;
    'Vec<mtc_shop_Catalog>': Vec<mtc_shop_Catalog>;
    'Vec<mtc_shop_CatalogLine>': Vec<mtc_shop_CatalogLine>;
    'Vec<mtc_shop_PlayerOperation_Buy>': Vec<mtc_shop_PlayerOperation_Buy>;
    'Vec<mtc_shop_PlayerOperation_Move>': Vec<mtc_shop_PlayerOperation_Move>;
    'Vec<mtc_shop_PlayerOperation_Sell>': Vec<mtc_shop_PlayerOperation_Sell>;
    'Vec<mtc_shop_PlayerOperation>': Vec<mtc_shop_PlayerOperation>;
    ...
    emo_ability_Ability: emo_ability_Ability;
    emo_ability_battle_AsAllyAction: emo_ability_battle_AsAllyAction;
    emo_ability_battle_Battle: emo_ability_battle_Battle;
    emo_ability_battle_General_AsAlly: emo_ability_battle_General_AsAlly;
    emo_ability_battle_General_AsOneself: emo_ability_battle_General_AsOneself;
    emo_ability_battle_General: emo_ability_battle_General;
    emo_ability_battle_GeneralAsAllyAction: emo_ability_battle_GeneralAsAllyAction;
    emo_ability_battle_GeneralAsAllyTrigger_AllyRetire: emo_ability_battle_GeneralAsAllyTrigger_AllyRetire;
    emo_ability_battle_GeneralAsAllyTrigger_AllySet: emo_ability_battle_GeneralAsAllyTrigger_AllySet;
    emo_ability_battle_GeneralAsAllyTrigger: emo_ability_battle_GeneralAsAllyTrigger;
    emo_ability_battle_GeneralAsOneselfTrigger_AllyBattleAbilityRemoved: emo_ability_battle_GeneralAsOneselfTrigger_AllyBattleAbilityRemoved;
    emo_ability_battle_GeneralAsOneselfTrigger_AllyRetire: emo_ability_battle_GeneralAsOneselfTrigger_AllyRetire;
    emo_ability_battle_GeneralAsOneselfTrigger_RivalRetire: emo_ability_battle_GeneralAsOneselfTrigger_RivalRetire;
    emo_ability_battle_GeneralAsOneselfTrigger: emo_ability_battle_GeneralAsOneselfTrigger;
    emo_ability_battle_NormalAction_AddBattleAbility: emo_ability_battle_NormalAction_AddBattleAbility;
    emo_ability_battle_NormalAction_DamageAll: emo_ability_battle_NormalAction_DamageAll;
    emo_ability_battle_NormalAction_DecreaseStats: emo_ability_battle_NormalAction_DecreaseStats;
    emo_ability_battle_NormalAction_IncreaseStats: emo_ability_battle_NormalAction_IncreaseStats;
    emo_ability_battle_NormalAction_IncreaseStatsByEmoCount: emo_ability_battle_NormalAction_IncreaseStatsByEmoCount;
    emo_ability_battle_NormalAction_SetEmo: emo_ability_battle_NormalAction_SetEmo;
    emo_ability_battle_NormalAction_SetEmosByAttackDiv: emo_ability_battle_NormalAction_SetEmosByAttackDiv;
    emo_ability_battle_NormalAction: emo_ability_battle_NormalAction;
    emo_ability_battle_Special: emo_ability_battle_Special;
    emo_ability_Destination: emo_ability_Destination;
    emo_ability_shop_AsAllyAction: emo_ability_shop_AsAllyAction;
    emo_ability_shop_NormalAction_AddAbility: emo_ability_shop_NormalAction_AddAbility;
    emo_ability_shop_NormalAction_GetCoin: emo_ability_shop_NormalAction_GetCoin;
    emo_ability_shop_NormalAction_GetCoinByEmoCountDiv: emo_ability_shop_NormalAction_GetCoinByEmoCountDiv;
    emo_ability_shop_NormalAction_IncreaseStats: emo_ability_shop_NormalAction_IncreaseStats;
    emo_ability_shop_NormalAction_IncreaseStatsByEmoCount: emo_ability_shop_NormalAction_IncreaseStatsByEmoCount;
    emo_ability_shop_NormalAction_IncreaseStatsByGrade: emo_ability_shop_NormalAction_IncreaseStatsByGrade;
    emo_ability_shop_NormalAction_IncreaseStatsOfAdjacentMenagerie: emo_ability_shop_NormalAction_IncreaseStatsOfAdjacentMenagerie;
    emo_ability_shop_NormalAction_SetEmo: emo_ability_shop_NormalAction_SetEmo;
    emo_ability_shop_NormalAction: emo_ability_shop_NormalAction;
    emo_ability_shop_Peri_AsAlly: emo_ability_shop_Peri_AsAlly;
    emo_ability_shop_Peri_AsOneself: emo_ability_shop_Peri_AsOneself;
    emo_ability_shop_Peri: emo_ability_shop_Peri;
    emo_ability_shop_PeriAsAllyAction: emo_ability_shop_PeriAsAllyAction;
    emo_ability_shop_PeriAsAllyTrigger_AllySet: emo_ability_shop_PeriAsAllyTrigger_AllySet;
    emo_ability_shop_PeriAsAllyTrigger: emo_ability_shop_PeriAsAllyTrigger;
    emo_ability_shop_PeriAsOneselfTrigger_AllySet: emo_ability_shop_PeriAsOneselfTrigger_AllySet;
    emo_ability_shop_PeriAsOneselfTrigger: emo_ability_shop_PeriAsOneselfTrigger;
    emo_ability_shop_Pre: emo_ability_shop_Pre;
    emo_ability_shop_RandomAction_IncreaseStatsOfMenagerie: emo_ability_shop_RandomAction_IncreaseStatsOfMenagerie;
    emo_ability_shop_RandomAction: emo_ability_shop_RandomAction;
    emo_ability_shop_Shop: emo_ability_shop_Shop;
    emo_ability_shop_Special: emo_ability_shop_Special;
    emo_ability_Side: emo_ability_Side;
    emo_ability_Target_Others: emo_ability_Target_Others;
    emo_ability_Target: emo_ability_Target;
    emo_ability_TargetOrRandom_Random: emo_ability_TargetOrRandom_Random;
    emo_ability_TargetOrRandom: emo_ability_TargetOrRandom;
    emo_ability_TypOptAndIsTripleOpt: emo_ability_TypOptAndIsTripleOpt;
    emo_Attributes: emo_Attributes;
    emo_Base: emo_Base;
    emo_Bases: emo_Bases;
    emo_Typ: emo_Typ;
    ...
    MortalEra: MortalEra;
    mtc_battle_Log_Add: mtc_battle_Log_Add;
    mtc_battle_Log_AddBattleAbility: mtc_battle_Log_AddBattleAbility;
    mtc_battle_Log_Attack: mtc_battle_Log_Attack;
    mtc_battle_Log_Damage: mtc_battle_Log_Damage;
    mtc_battle_Log_DecreaseStats: mtc_battle_Log_DecreaseStats;
    mtc_battle_Log_IncreaseStats: mtc_battle_Log_IncreaseStats;
    mtc_battle_Log_Remove: mtc_battle_Log_Remove;
    mtc_battle_Log_RemoveBattleAbility: mtc_battle_Log_RemoveBattleAbility;
    mtc_battle_Log: mtc_battle_Log;
    mtc_battle_Logs: mtc_battle_Logs;
    mtc_Board: mtc_Board;
    mtc_BoardEmo: mtc_BoardEmo;
    mtc_Emo: mtc_Emo;
    mtc_Ghost: mtc_Ghost;
    mtc_GhostBoard: mtc_GhostBoard;
    mtc_GhostBoardEmo: mtc_GhostBoardEmo;
    mtc_GhostState_Active: mtc_GhostState_Active;
    mtc_GhostState_Retired: mtc_GhostState_Retired;
    mtc_GhostState: mtc_GhostState;
    mtc_GradeAndBoard: mtc_GradeAndBoard;
    mtc_GradeAndGhostBoard: mtc_GradeAndGhostBoard;
    mtc_shop_BoardLog_Add: mtc_shop_BoardLog_Add;
    mtc_shop_BoardLog_AddAbility: mtc_shop_BoardLog_AddAbility;
    mtc_shop_BoardLog_IncreaseStats: mtc_shop_BoardLog_IncreaseStats;
    mtc_shop_BoardLog_Move: mtc_shop_BoardLog_Move;
    mtc_shop_BoardLog_Remove: mtc_shop_BoardLog_Remove;
    mtc_shop_BoardLog_Triple: mtc_shop_BoardLog_Triple;
    mtc_shop_BoardLog: mtc_shop_BoardLog;
    mtc_shop_BoardLogs: mtc_shop_BoardLogs;
    mtc_shop_Catalog: mtc_shop_Catalog;
    mtc_shop_CatalogLine: mtc_shop_CatalogLine;
    mtc_shop_PlayerOperation_Buy: mtc_shop_PlayerOperation_Buy;
    mtc_shop_PlayerOperation_Move: mtc_shop_PlayerOperation_Move;
    mtc_shop_PlayerOperation_Sell: mtc_shop_PlayerOperation_Sell;
    mtc_shop_PlayerOperation: mtc_shop_PlayerOperation;
