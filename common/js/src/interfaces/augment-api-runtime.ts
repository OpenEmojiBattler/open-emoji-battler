...
import type { AccountId, Block, Hash, Header, Index, KeyTypeId, SlotDuration } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/api-base/types/calls' {
  interface AugmentedCalls<ApiType extends ApiTypes> {
    ...
    blockBuilder: {
       ...
       **/
      randomSeed: AugmentedCall<ApiType, () => Observable<Hash>>;
      /**
       * Generic call
       **/
      [key: string]: DecoratedCallBase<ApiType>;
    ...
    taggedTransactionQueue: {
       ...
       **/
      validateTransaction: AugmentedCall<ApiType, (source: TransactionSource | 'InBlock' | 'Local' | 'External' | number | Uint8Array, tx: Extrinsic | IExtrinsic | string | Uint8Array) => Observable<TransactionValidity>>;
      /**
       * Generic call
       **/
      [key: string]: DecoratedCallBase<ApiType>;
